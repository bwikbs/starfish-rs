...
**Epic 14 complete.** 953 workspace tests, clippy clean. Native form controls across three
milestones, byte-identical for form-free pages: text controls (M1), checkbox/radio/select
(M2), and form-state pseudo-classes + disabled greying + hidden + color/range (M3).
